...
description: |
  ...
  修改(fiction-write 内建修改模式)、审查(fiction-review)、润色(fiction-polish)等。
  未明确指定操作时，分析意图后路由。
---
...
| 修改已写章节 | 修改、重写、回炉、不满意、这章不太对 | `fiction-write`（内建修改模式） |
...
<!-- fiction: 路由入口 · 共 15 个子模块（fiction-revise 已合并到 fiction-write） -->
